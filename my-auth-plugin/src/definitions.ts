...
export interface MsAuthPlugin {
  login(options: LoginOptions): Promise<{ accessToken: string; idToken: string; scopes: string[]  } | null>;
  logout(options: LogoutOptions): Promise<void>;
  getAccount(options?: LogoutOptions): Promise<{ accessToken: string; idToken: string; scopes: string[] } | null> 
handleRedirect(options?: LogoutOptions): Promise<{ accessToken: string; idToken: string; scopes: string[]}  | null>
}